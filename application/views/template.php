	...
	<div class="wrapper">
  		<header class="main-header">
    		<a href="<?=base_url('dashboard')?>" class="logo">
      			...
      			<span class="logo-lg">sistem rumah sakit</span>
    		</a>
	    ...
	    <section class="sidebar">
	      <div class="user-panel">
	        <div class="pull-left image">
	          <img src="<?=base_url()?>assets/dist/img/logo.png" class="img-circle">
	        </div>
	      ...
	      <ul class="sidebar-menu" data-widget="tree">
	        ...
	        <li>
	            <a href="<?=site_url('peminjaman')?>"> <span>Peminjaman</span></a>
	        </li>
	        <li>
	            <a href="<?=site_url('Pengembalian')?>"> <span>Pengembalian</span></a>
	        </li>
	        <li class="treeview">
	          <a href="#">
	          ...
	          <ul class="treeview-menu">
	            ...
	            <li><a href="#"><i class="fa fa-circle-o"></i> Laporan User</a></li>
	          </ul>
	        </li>
